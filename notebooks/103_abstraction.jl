...
# ╔═╡ 74e6a240-828f-4b05-9996-91bbbc1472d1
using IntervalArithmetic, ForwardDiff, OrdinaryDiffEq

# ╔═╡ 84f3c3f4-cbd1-4433-8a06-2a7fc44d4268
using CUDA , StaticArrays, SparseArrays

# ╔═╡ 294df291-b5fc-4a48-ae2a-b186313b2924
html"""
<style>
	@media screen {
		main {
...
# ╔═╡ db6e50c9-14a8-4d69-98f4-ca9d5108462b
...
# ╔═╡ 259f87fd-dc50-404c-9324-e2e25329a6d4


# ╔═╡ cac09638-c4ea-4f05-a7f6-459cd871f727
md"
...
# ╔═╡ d4e7223b-3b1a-425f-bbe4-72e6d6c042bf


# ╔═╡ 9aadf790-7d9c-481b-af91-ed223bcda25e


# ╔═╡ 314a8ec7-dba6-4cdf-a957-60934f102d3c
md"""
...
# ╔═╡ 0c3bc180-c74c-4768-8726-02b85f496ced


# ╔═╡ 03b3c0df-ab05-4d24-90ba-005e7d4dcde5
begin 
...
# ╔═╡ 29a3a9ad-7669-4145-a0d4-c8405252da4e


# ╔═╡ c0e0f3c5-17c7-4a34-b256-57a57f50b9a1
...
# ╔═╡ 514e7fcb-0c6a-40c5-86e5-5b85683fa97f


# ╔═╡ 4c3b55c0-ccbd-48b9-b36b-fe0362e8ee43
md"Concrete implemenations:"

# ╔═╡ f20da673-248e-4eaa-bc12-489d9bd0c603
struct Dog <: AbstractAnimal
	name
	age
end

# ╔═╡ 07e09f60-d97b-4165-80a8-99b6e7162eae
...
# ╔═╡ 98cf7270-315d-4bd4-afc1-ed4d6878163c


# ╔═╡ 2fe40731-ef23-426f-a611-b168bc8de0ff
md"Implementation of the interface function `greet`:"

# ╔═╡ 9800751f-fc33-447f-9765-4f5542ad10a9
begin
	greet(a::Human, b::Dog) = println(a.name, " says:", " Sit ",  b.name, "! Brave dog...")
	greet(a::Dog, b::Dog)   = println(a.name, ": Wuff!, Wuff!  ", b.name, ": Wuff!")
end

# ╔═╡ 20b6c0db-d489-4327-b52a-f3ba3592a168


# ╔═╡ c0b9b22b-e119-4ee5-a736-eed20023fa0e


# ╔═╡ 6bf1ecfc-f30d-4bcc-bc48-e3af21e8e170
🙂 = Human("Steffen", "Plunder", 24, :orange)

# ╔═╡ 971f30e4-4730-4be8-ad9f-b3ebb674956d
🐶 = Dog("Max", 3)

# ╔═╡ a8680453-eedb-4a49-8281-143ed223fd9c
🐕 = Dog("Cate", 3)

# ╔═╡ ceebf360-72b7-4b06-a98a-c93a4836fdc5
begin
	greet(🙂, 🐶)
	greet(🐶, 🐕)
end

# ╔═╡ a59918e6-7232-4df7-ad20-5c64422a66bb


# ╔═╡ 73915107-2f17-4942-a9a7-5705a48688b8


# ╔═╡ 16ab4672-4ccd-402f-ac25-8452649fc6d2
md"""
# Abstract interfaces in practice
"""

# ╔═╡ 5605c25b-6496-4bfe-9952-cb65a80577d2


# ╔═╡ fd9116aa-8bf9-4488-ad4c-a38dfad805d8
md"## AbstractNumbers"

# ╔═╡ 7557359d-17c6-4517-9de1-783d797cdc27
begin
	u0 = 1.0
...
# ╔═╡ 03f3dc96-39f7-4eec-96e5-a11b0930139f


# ╔═╡ ee9c1064-1c55-49e0-9feb-3c921dc623f5


# ╔═╡ 6d8ef07e-a6c8-4038-a218-4bcb3bfb6c8f
md"## AbstractArrays 
...
# ╔═╡ f43a0c0f-adae-486e-af0e-d1e4d1b00f14


# ╔═╡ e3b88973-5304-49a0-94a9-7d10971894ce
md"### Example: GPU computing 💻"

# ╔═╡ 6344ae19-092d-4d11-8d06-11e6eb2c325f
x_cpu = rand(100_000_000);

# ╔═╡ 90d0866a-8c1c-44f7-bfd7-edf82b9796d8
x_gpu = CUDA.cu(x_cpu);

# ╔═╡ aba1acc6-7039-4657-8318-302b4b680235


# ╔═╡ 124bbbc1-57a4-4afb-a9e8-3197150b96de
md"### Works like an array 😜"

# ╔═╡ 8800bcb8-29eb-4971-98a6-90e1322bdefd
@time sum(x_cpu);

# ╔═╡ 6af0199f-4167-4784-9447-01421cb4937d
@time sum(x_gpu);

# ╔═╡ 616bbe3a-977b-4127-9d47-53a16c382cae


# ╔═╡ bccdf901-4612-47c3-ba85-075d7bf7b635


# ╔═╡ 32963235-4411-4de8-8c40-98ca8bf46fbb
md"""
_Side note:_
...
# ╔═╡ 4d6b3461-692e-4f75-b30b-253c28f3751c


# ╔═╡ 9f7bdadf-bc8a-4afc-a83d-350cf0d9e02d


# ╔═╡ 2be91568-a2db-45d0-bcc3-ed5bfff78471


# ╔═╡ 806d0010-b7ea-46fd-89b7-bbec4039fa70
md"### ⇒ Abstract interfaces are the foundation how independent (small) projects can integrate well with each other, without unwanted dependencies!"
